...
module.exports = {
  officialUrls: {
    daya_tampung: 'https://smits.its.ac.id/daya-tampung/',
    passing_grade: null,
  },
  affiliatedUrls: {
    zenius: 'https://zenius.net/blog/passing-grade-its',
  ...
  async scrapeOfficial() {
    try {
      ...
      console.warn('[its] official scrape failed:', err.message);
      return [];
    }
  },
